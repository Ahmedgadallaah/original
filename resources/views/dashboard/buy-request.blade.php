                                            ...
                                            <div class="row">
                                                <div class="col-md-2">
                                                    <div class="product-percen-sub">
                                                        <div class="chart" data-percent="20"
                                                            data-scale-color="#EE504F">
                                                            <span> <strong>{{ count($shipped_orders) }}</strong> <br> قطعة
                                                            </span>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="row">
                                                                ...
                                                                <div class="col-md-8">
                                                                    <div class="prod-txts-parts">
                                                                        ...
                                                                        <span> <i class="fas fa-map-marker-alt"></i>
                                                                            {{ $order->order->address }} </span>
                                                                        <span> <i class="fas fa-clock"></i>
                                                                            {{ $order->order->created_at->format('l j F Y') }}
                                                                        </span>
                                                                        <span> <i class="fas fa-wallet"></i> الدفع عن
                                                                            الاستلام </span>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div>
                                                                        <small style="color: #59626B; font-size: 12px;"> رقم
                                                                            الهاتف :{{ $order->order->phone }} </small>
                                                                    </div>
                                                                    <div>
                                                                        <small style="color: #EE504F;">السعر
                                                                            :{{ $order->product_price }} </small>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="info-details">
                                                                                        ...
                                                                                        <div class="details-sub">
                                                                                            ...
                                                                                            <h6>{{ $order->order->user->name ?? '' }}
                                                                                            </h6>
                                                                                        </div>
                                                                                        <div class="details-sub">
                                                                                            <span>رقم التيلفون</span>
                                                                                            <h6>{{ $order->order->phone }}
                                                                                            </h6>
                                                                                        </div>
                                                                                        <div class="details-sub">
                                        ...
                                        <i class="fas fa-check"></i> تم التسليم
                                                                        ...
                                                                        <div class="col-md-4">
                                                                            <div class="add-prod-right-sub">
                                                                                <div class="sub-img">
                                                                                    <img src="images/add-prod-subImg.png"
                                                                                        alt="">
                                                                                </div>
                                                                                <div class="list-sub">
                                                                                    <h6>معلومات تهمك</h6>
                                                                                    <span>
                                                                                        <span class="number-sub"> 1
                                                                                        </span>
                                                                                        إحرص علي تسليم القطعة في إسرع وقت
                                                                                        لكسب
                                                                                        ثقة العميل
                                                                                    </span>
                                                                                    <span>
                                                                                        <span class="number-sub"> 2
                                                                                        </span>
                                                                                        إحرص علي التواصل مع العميل من خلال
                                                                                        الرسائل في حالة الأستلام
                                                                                    </span>
                                                                                    <span>
                                                                                        <span class="number-sub"> 3
                                                                                        </span>
                                                                                        إذا واجعتك مشكلة تواصل معانا في أي
                                                                                        وقت فنحن هنا من أجلك
                                                                                    </span>
                                                                                    <span>
                                                                                        <span class="number-sub"> 4
                                                                                        </span>
                                                                                        تابع مخزون القطع إول بأول لعدم وقم
                                                                                        بالتأكدمن وجود القطع فى متجرك
                                                                                    </span>
                                                                                    <span>
                                                                                        <span class="number-sub"> 5
                                                                                        </span>
                                                                                        قم بفحص القطعة جيداً قبل تسليمه
                                                                                        وتأكد انها مطابقة ولا يوجد بها مشاكل
                                                                                    </span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
