                                        ...
                                        <div class="chart-bg">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <span><small
                                                            style="font-size: 10px; display: block; margin-top: -10px;">أجمالي
                                                            الربح</small></span>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="prod-img-parts">
                                                                        <img src="{{ Storage::disk('public')->url($item->product->image ?? '') }}"
                                                                        {{-- @dd($item)   --}}
                                                                            width="100%">
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-8">
                                                                    <div class="prod-txts-parts">
                                                                        ...
                                                                        <span> الكمية المطلوبة
                                                                            <b>{{ $item->product_qty }}</b> قطعة </span>
                                                                        <span> <i class="fas fa-clock"></i>
                                                                            {{ $item->created_at->format('l j F Y') }}
                                                                        </span>
                                                                ...
                                                                <div class="col-md-9">
                                                                    <div class="text-left">
                                                                        <a href="" class="see"
                                                                            ...
                                                                            <img src="{{ asset('dash/images/see-ic.png') }}"
                                                                                width="25"></a>
                                                                                ...
                                                                                <div
                                                                                    ...
                                                                                    <div class="info-details">
                                                                                        ...
                                                                                        <div class="details-sub">
                                                                                            ...
                                                                                            <h6>{{ $item->order->user->name ?? '' }}
                                                                                            </h6>
                                                                                        </div>
                                                                                        <div class="details-sub">
                                                                                            <span>رقم التيلفون</span>
                                                                                            <h6>{{ $item->order->user->phone ?? '' }}
                                                                                            </h6>
                                                                                        </div>
                                                                                        <div class="details-sub">
