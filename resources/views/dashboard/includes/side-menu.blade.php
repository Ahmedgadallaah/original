      <div class="fixed-menu">
            ...
            <div class="fixed-menu-padd">
                <ul>
                    ...
                    <li class="@if(\Route::currentRouteName()=='part-request') liactive @endif"><a href="{{ route('part-request') }}"><i class="fas fa-sign-out-alt"></i> طلبات القطع</a></li>
                    <li class="@if(\Route::currentRouteName()=='chat') liactive @endif"><a href="{{ route('chat') }}"><i class="fas fa-comment-alt"></i> الرسايل</a></li>
