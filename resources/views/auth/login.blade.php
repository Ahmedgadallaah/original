            ...
            <div class="row">
                <div class="col-md-5">
                    ...
                    <div class="fields-login-side">
                        <div class="upp-login">
                            <h5>تسجيل الدخول</h5>
                            <p>قم بأدخال رقم الهاتف وكلمة المرور</p>
                        </div>
                        ...
                        <div class="field-input-login-side">
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="form_field">
                                    <input type="text" name="phone" class="form_input @error('phone') is-invalid @enderror"
                                        placeholder="الهاتف" value="{{ old('phone') }}" required autocomplete="phone"
                                        autofocus>
                                ...
                                <div class="form_field">
                                    <input id="password" name="password" type="password"
                                        class="form_input @error('password') is-invalid @enderror" placeholder="كلمة المرور"
